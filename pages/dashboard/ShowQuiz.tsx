...
export default function Quiz() {
	...
	if (typeof window !== 'undefined') {
		myClassID = window?.localStorage.getItem("classID");
		myCourseName = window?.localStorage.getItem("courseName");
	}

	const [classID, setClassID] = useState<ClassID>({ class_id: myClassID });
	const [courseName, setCourseName] = useState<string>(myCourseName);
