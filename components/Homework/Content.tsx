...
const HomeworkContent = ( props: { typeOfHomework: HomeworkType}) => {
    ...
    return (
        ...
        <div className=" flex">
            {
                props.typeOfHomework === HomeworkType.submission ? <SubmissionContent /> : null
            }
            {
                props.typeOfHomework === HomeworkType.multipleChoice ? <MultipleChoiceContent /> : null
            }
        </div>
