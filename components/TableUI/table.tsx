...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={`mt-4 text-sm text-muted-foreground $s{className}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ul ref={ref} className={`list-none ${className}`} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <li ref={ref} className={`border-b ${className}`} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <span ref={ref} className={`block p-2 ${className}`} {...props} />
));
