...
const FamilyInfo = () => {
    ...
    const family: Family = {
        ...
        FamilyAddress: "dia chi theo ho kha ấddfsadfasdfsdfadfsdfsdafsadffsdafadsfdu",
    };

    return (
        <div className=" w-full min-h-screen p-10 md:p-4
                        border shadow-gray-200 shadow-sm rounded-lg">
            <div className="w-[98%] max-h-screen px-2  md:p-6 
                            rounded-lg shadow-sm">
                <div className="w-full mb-4 px-4 py-2
                                font-bold text-white text-2xl bg-sky-500 rounded-xl">Nơi ở hiện tại của sinh viên</div>
            ...
            <div className="w-[98%] max-h-screen px-2 md:p-6 
                            rounded-lg shadow-sm">
            <div className="w-full mb-4 px-4 py-2   
                            font-bold text-white text-2xl bg-sky-500 rounded-xl">Người thân liên lạc khi cần thiết</div>
            <div className="border border-gray-200 p-4 rounded-xl mb-4">
                    <div className="space-y-3 pl-10 text-lg">
                                <div className="md:flex justify-start border-solid">
